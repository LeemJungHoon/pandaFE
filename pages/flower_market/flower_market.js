...
const allFlowerContainer = document.getElementsByClassName("all_flower_container")[0];
...
window.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
      ...
      // 쿼리스트링 page=1로 불러서 1페이지에 들어갈 상품값을 불러옴.
       await fetch("http://kdt-sw-6-team10.elicecoding.com/api/items/category/Flower_Market/?page=1", {
          headers: {
...
totalPageBtn.addEventListener("click",  async (e) => {
  ...
  try {
    ...
    const normalPageUrl = `http://kdt-sw-6-team10.elicecoding.com/api/items/category/Flower_Market/?page=${current_page_num}`;
