...
const orderCheckMemberNumber = document.getElementById('ordercheck_member_number');
const orderCheckMemberaddr = document.getElementById('ordercheck_member_address');
            ...
            .then((data) => {
                for (let i = 0; i < data.length; i++) {
                    ...
                    const orderCheckMemberItemBody = `
                        <div class="left">
                            <img src="http://kdt-sw-6-team10.elicecoding.com/${itemImgURL}" alt="">
                        </div>
                        <div class="right">
...
payBtn.addEventListener('click', () => {
    ...
    fetch('http://kdt-sw-6-team10.elicecoding.com/api/order', {
        method: 'POST',
        headers: {
