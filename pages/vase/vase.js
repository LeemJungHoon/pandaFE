...
const allVaseContainer =
  document.getElementsByClassName("all_vase_container")[0];
...
window.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    await fetch("https://panda-be.vercel.app/api/items/category/Vase/?page=1", {
      headers: {
...
totalPageBtn.addEventListener("click", async (e) => {
  try {
    ...
    const normalPageUrl = `https://panda-be.vercel.app/api/items/category/Vase/?page=${current_page_num}`;
